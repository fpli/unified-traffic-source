...
from
	...
	on a.dt BETWEEN '${dt_2_formated}' and '${dt_1_formated}' and a.EXPERIENCE <> 'native' and b.IFRAME = 0 and a.PAGE_ID = b.PAGE_ID) c
inner join ubi_t.unified_session_map d
on ((d.dt = '${dt_1}' AND d.session_type = 'sameday') or (d.dt = '${dt_2}' AND d.session_type = 'crossday'))
